...
from pot.core.hrm_controller import HRMPointerController, HRMState
from pot.core.controller_factory import create_controller
from pot.models.hybrid_hrm import HybridHRMBase
from pot.models.puzzle_embedding import PuzzleEmbedding
from pot.models.adaptive_halting import QHaltingController
from pot.models.hrm_layers import RMSNorm, SwiGLU
...
class PoHSudokuSolver(nn.Module):
    ...
    def _detach_controller_state(self, state):
        ...
        if hasattr(state, 'h') and hasattr(state, 'c') and hasattr(state, 'step'):
            from pot.core.lstm_controllers import LSTMDepthState
        ...
        if hasattr(state, 'n') and hasattr(state, 'm'):
            from pot.core.lstm_controllers import xLSTMDepthState
        ...
        if hasattr(state, 'u_list'):
            from pot.core.depth_transformer_controller import DepthControllerCache
